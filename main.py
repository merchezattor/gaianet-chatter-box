...
from generator import get_words_list, get_random_word, get_question_templates, get_random_question_local
...
while True:
    ...
    random_question = get_random_question_local(words, question_templates)
